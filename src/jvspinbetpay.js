...
class JvPaymentAPIClient {
    constructor() {
        this.cashdeskPassword = config.PAYMENT_CLIENT.JVCASHDESK_PASSWORD;
        this.cashdeskId = config.PAYMENT_CLIENT.JVCASHDESK_ID;
        this.apiKey = config.PAYMENT_CLIENT.JVAPI_KEY;
...
module.exports = JvPaymentAPIClient;
